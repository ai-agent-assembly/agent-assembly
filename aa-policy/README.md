...
resolving overlapping rules, and tracking a policy's version history. A
deliberate leaf crate (AAASM-5349) shared by `aa-gateway`, `aa-runtime`, and
`aa-cli` so none of those three has to depend on another for policy semantics.
