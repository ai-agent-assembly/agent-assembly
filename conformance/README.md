...
│   ├── zh_tw_detection/        # 19 vectors: Taiwanese IDs, 統一編號, phone numbers
...
parenthesised and `+886` forms. Seven of the nineteen are negatives: checksum
near-misses (including the legacy certificate's check digit), digit runs that are
fragments of longer numbers, 8-digit runs bounded by ASCII or full-width machine
delimiters, phone shapes with an unissued area code, and clean
