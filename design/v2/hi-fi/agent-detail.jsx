          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            ...
            <div style={{ background: 'var(--paper-2)', border: '1px solid var(--line)', borderRadius: 3, padding: 16 }}>
              ...
              <div style={{ display: 'flex', height: 36, border: '1px solid var(--line-2)', borderRadius: 2, overflow: 'hidden', marginTop: 6 }}>
                <div style={{ flex: 0.62, background: 'var(--paper)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 10, fontFamily: 'JetBrains Mono', color: 'var(--ok)', borderRight: '1px solid var(--line-2)' }}>allow 62%</div>
