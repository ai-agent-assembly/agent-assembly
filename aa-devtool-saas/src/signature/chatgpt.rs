//! OpenAI ChatGPT webhook signature verification.
//!
//! Header: `openai-signature`. Value format: `sha256=<hex>`.
...
/// HTTP header carrying the OpenAI HMAC-SHA256 signature.
const HEADER: &str = "openai-signature";

/// Verify a ChatGPT webhook signature.
///
