...
fn try_sys_openat_ret(ctx: &RetProbeContext) -> Result<u32, u32> {
    ...
    let mut event = FileIoEventRaw {
        ...
        tid: pid,
        timestamp_ns: 0,
        syscall: SyscallType::Openat as u32,
        flags: 0,
        return_code: 0,
        duration_ns: 0,
        path: *path,
...
fn try_sys_read_ret(ctx: &RetProbeContext) -> Result<u32, u32> {
    ...
    let mut event = FileIoEventRaw {
        ...
        tid: pid,
        timestamp_ns: 0,
        syscall: SyscallType::Read as u32,
        flags: 0,
        return_code: 0,
        duration_ns: 0,
        path: *path,
...
fn try_sys_write_ret(ctx: &RetProbeContext) -> Result<u32, u32> {
    ...
    let mut event = FileIoEventRaw {
        ...
        tid: pid,
        timestamp_ns: 0,
        syscall: SyscallType::Write as u32,
        flags: 0,
        return_code: 0,
        duration_ns: 0,
        path: *path,
...
fn try_sys_unlink_ret(ctx: &RetProbeContext) -> Result<u32, u32> {
    ...
    let mut event = FileIoEventRaw {
        ...
        tid: pid,
        timestamp_ns: 0,
        syscall: SyscallType::Unlink as u32,
        flags: 0,
        return_code: 0,
        duration_ns: 0,
        path: *path,
...
fn try_sys_rename_ret(ctx: &RetProbeContext) -> Result<u32, u32> {
    ...
    let mut event = FileIoEventRaw {
        ...
        tid: pid,
        timestamp_ns: 0,
        syscall: SyscallType::Rename as u32,
        flags: 0,
        return_code: 0,
        duration_ns: 0,
        path: *path,
