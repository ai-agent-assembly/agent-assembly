...
// foundation on 4560 — are untouched) since the square VerdictChip callers are
// proven in isolation from the Storybook harness rather than a product route.
// (The ApprovalDetailDrawer shell this also captured was removed with the dead
// drawer in AAASM-5166.)
